...
const DESCRIPTION =
  "Кулинарное квест-шоу в стиле Адской кухни для взрослых: корпоративы, тимбилдинги, дни рождения, мальчишники. От 8 до 40 участников, ведущий-шоумен, 4 блюда и финальная битва.";
...
const heroBenefits = [
  "От 8 до 40 участников",
  "Ведущий-шоумен",
  "4 блюда и финальная битва",
...
const steps = [
  ...
  { icon: Utensils, title: "4 блюда", text: "Слепая дегустация, скорость, точность, вкус." },
...
const formats = [
  ...
  { title: "Юбилей компании", text: "Масштабный формат до 40 участников.", img: win },
...
const gallery = [
  ...
  { src: g5, alt: "Огонь на сковороде во время приготовления блюда", cls: "" },
  { src: win, alt: "Награждение победителей кулинарного шоу", cls: "md:col-span-2" },
  { src: g1, alt: "Скоростная нарезка при приготовлении блюда", cls: "" },
...
const faq = [
  {
    ...
    a: "Стандартный формат — 2,5 часа: знакомство с шефом, 4 блюда, финальная битва и награждение. Дальше по желанию остается общий ужин из приготовленных блюд и кейтеринга. А после вас ждет увлекательная диско-программа.",
  },
  {
    q: "Нужен ли опыт готовки?",
    a: "Нет. Все задания рассчитаны на новичков: шеф показывает технику, су-шефы страхуют команды. Половина наших гостей до игры не готовила ничего сложнее яичницы.",
  },
  {
    q: "Можно ли участвовать большой компанией?",
    a: "Да, мы проводим игры от 8 до 40 человек. Для групп больше 20 участников добавляем дополнительно две команды.",
  },
  {
    q: "Можно ли заказать фотографа?",
    a: "Да, фотограф входит в пакет «Премиум» или заказывается отдельно. Также можно заказать услуги видеооператора. Фото передаем в течение 2 дней, ролик — до 5 дней.",
  },
];
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <Reveal>
              ...
              <p className="mt-6 max-w-xl text-muted-foreground">
                Участники делятся на команды, готовят 4 блюда, соревнуются за победу и получают
